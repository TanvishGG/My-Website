  ...
  return (
    <div className="mt-8 sm:w-1/2 flex flex-col border-2 border-cyan-200 items-center justify-center text-center bg-gray-800/30 p-4 md:p-8 rounded-lg shadow-lg">
      <Form action={handleSubmit} className="w-full">
        ...
        <button
          type="submit"
          className="mt-4 w-full cursor-pointer px-4 py-2 bg-cyan-500 text-white font-medium rounded-md shadow-sm hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
        >
          Submit
        </button>
      </Form>
