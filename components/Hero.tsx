    ...
    return (
        <div className="flex-col sm:flex-row flex rounded-xl w-90/100 items-center justify-around p-4 bg-gray-900/50 backdrop-blur-xs shadow-lg border-2 border-gray-700/50">
            <div className="flex sm:w-1/2 flex-col items-center justify-center">
                <h1 className="text-4xl font-bold text-white">Hey, I&apos;m  <span className="text-cyan-400 font-bold">Tanvish</span></h1>
                <Image
                    src="/logo.webp"
                    alt="Profile Picture"
                    width={150}
            ...
            <div className="mt-8 sm:w-1/2 flex flex-col border-2 border-cyan-200 items-center justify-center text-center bg-gray-800/30 p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-300 leading-relaxed">
                    I am a <span className="text-cyan-400 font-bold">Web and App Developer</span> skilled in
                    <span className="text-cyan-400 font-bold"> Node.js</span>,
                    <span className="text-cyan-400 font-bold"> React Native</span>,
                    and <span className="text-cyan-400 font-bold"> Express</span>. Pursuing a
                    <span className="text-cyan-400 font-bold"> BTech in Computer Science</span> at
                    <span className="text-cyan-400 font-bold"> VIT-AP University</span>, I am passionate
                    about <span className="text-cyan-400 font-bold"> Technology</span>,
                    <span className="text-cyan-400 font-bold"> Nature</span>,
                    and blending creativity with <span className="text-cyan-400 font-bold"> Portrait Sketching</span>.
                </p>
