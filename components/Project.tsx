...
export default function Project({title, description, image, link}: {title: string, description: string, image: string, link: string}) {
    return (
        <div className="flex border-2 transition-all border-gray-900/60 hover:scale-105 hover:shadow-gray-700/50 items-center h-50 w-80 p-4 rounded-lg shadow-md bg-gray-900/40 backdrop-blur-xs">
